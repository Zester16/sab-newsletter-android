package com.oschmid.sabnewsletter.views.usernavigation
...
import com.oschmid.sabnewsletter.views.navdrawer.NavigationDrawerViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun UserNavigationBottomSheet(
