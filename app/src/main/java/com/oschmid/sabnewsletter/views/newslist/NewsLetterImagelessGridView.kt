package com.oschmid.sabnewsletter.views.newslist
...
import com.oschmid.sabnewsletter.ui.theme.fontUbuntu
import com.oschmid.sabnewsletter.utils.invokeNavigationToInternalWebBrowser

@Composable
fun NewsLetterImagelessGridView(
    newsletterList: List<SabencosNewsletterImagelessDomain?>,
    ...
    LazyVerticalGrid(
        ...
        Modifier.background(color = SabencosYellow)
    ) {

        item {
            val mintBanner = painterResource(id = R.drawable.ming_top_of_morning)
            Image(
                painter = mintBanner,
...
@Composable
fun NewsletterJustDateView(
    news: SabencosNewsletterImagelessDomain,
    navController: NavHostController
) {
    Card(
        onClick = {
