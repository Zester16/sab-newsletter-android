...
class WsjNewsletterVMFactory(private val newsletterRepository: SabencosNewsletterRepository) :
    ViewModelProvider.NewInstanceFactory() {
    override fun <T : ViewModel> create(modelClass: Class<T>, extras: CreationExtras): T =
        WsjNewsletterViewmodel(newsletterRepository = newsletterRepository) as T
