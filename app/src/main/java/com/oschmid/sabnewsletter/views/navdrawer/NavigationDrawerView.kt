package com.oschmid.sabnewsletter.views.navdrawer
...
import com.oschmid.sabnewsletter.R
import com.oschmid.sabnewsletter.navigation.NavGraph
...
import com.oschmid.sabnewsletter.ui.theme.fugazOne
import com.oschmid.sabnewsletter.views.usernavigation.UserNavigationBottomSheet
...
fun NavigationDrawerApp(
    ...
    viewmodel: NavigationDrawerViewModel = NavigationDrawerViewModel(),
    ...
    ModalNavigationDrawer(
        drawerContent = {
            ModalDrawerSheet {
                ...
                Row {
                    ImageVector(
                        painter = sabencosIcon,
                        contentDescription = "sabencos logo",
                        modifier = Modifier
                            .width(90.dp)
                            .height(90.dp),
                ...
                NavigationDrawerItem(
                    ...
                    onClick = {
                        navController.navigate(NavigationConstant.LIVEMINT) {
                            popUpTo(NavigationConstant.DASHOBARD)
                        }
                        scope.launch {
                            drawerState.close()
                ...
                NavigationDrawerItem(
                    ...
                    onClick = {
                        navController.navigate(NavigationConstant.WSJ) {
                            popUpTo(NavigationConstant.DASHOBARD)
                        }
                        scope.launch {
                            drawerState.close()
                ...
                NavigationDrawerItem(
                    ...
                    onClick = {
                        navController.navigate(NavigationConstant.BLOOMBERG) {
                            popUpTo(NavigationConstant.DASHOBARD)
                        }
                        scope.launch {
                            drawerState.close()
